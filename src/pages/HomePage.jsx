    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-primary-100 overflow-hidden relative">
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              {session ? (
                ...
                <>
                  ...
                  <Link to="/signup">
                    <button className="h-10 px-6 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-full text-sm transition-all shadow-sm hover:shadow-md transform hover:-translate-y-0.5">
                      Get Started
                    </button>
                  </Link>
                </>
          ...
          <div className="flex-1 text-center lg:text-left max-w-2xl lg:max-w-xl mx-auto lg:mx-0 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <Link to={session ? "/dashboard" : "/signup"} className="w-full sm:w-auto">
                <button className="w-full sm:w-auto h-14 px-8 bg-slate-900 hover:bg-slate-800 text-white font-semibold text-lg rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group transform hover:-translate-y-1">
                  Start for free
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-100">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <Link to="/signup">
            <button className="h-14 px-10 bg-primary-600 hover:bg-primary-700 text-white font-bold text-lg rounded-full shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5">
