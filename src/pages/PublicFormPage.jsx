...
export default function PublicFormPage() {
 ...
 className="text-white px-8 py-3 rounded-xl font-bold text-lg transition-all shadow-lg disabled:opacity-70 disabled:pointer-events-none"
 ...
 <button
 type="submit"
 className="text-white px-8 py-3 rounded-xl font-bold text-lg transition-all shadow-lg"
 style={{ backgroundColor: form.theme_color || '#0b5cff', boxShadow: `0 10px 15px -3px ${(form.theme_color || '#0b5cff')}40` }}
 >
 Berikutnya
 </button>
