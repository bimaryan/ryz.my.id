...
export default function ApiKeysPage() {
 ...
 <div>
 <Button onClick={() => setIsModalOpen(true)} className="bg-gradient-to-r from-[#0b5cff] to-indigo-600 hover:from-[#094acc] hover:to-indigo-700 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-lg shadow-blue-500/30 whitespace-nowrap">
 ...
 <Button type="submit" isLoading={isLoading} className="bg-gradient-to-r from-[#0b5cff] to-indigo-600 hover:from-[#094acc] hover:to-indigo-700 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-md shadow-blue-500/20">Buat Kunci</Button>
 </div>
 </form>
 )}
 </div>
