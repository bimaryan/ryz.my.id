          ...
          {links && links.length > 0 ? (
            links.map((link, i) => (
              <a
                ...
                className={`block w-full py-4 px-6 text-lg font-bold transition-all duration-300 ${theme.button_animation || 'hover:scale-[1.02]'} active:scale-[0.98] ${theme.button_style} ${theme.button_shadow} ${theme.button_border} border relative overflow-hidden`}
