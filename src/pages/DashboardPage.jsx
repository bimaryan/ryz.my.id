...
export default function DashboardPage() {
 ...
 <Button
 type="submit"
 className="bg-gradient-to-r from-[#0b5cff] to-indigo-600 hover:from-[#094acc] hover:to-indigo-700 text-white px-7 py-3 rounded-xl font-bold transition-all shadow-lg shadow-blue-500/30 whitespace-nowrap"
 disabled={isCreating}
 >
 ...
 <div
 key={link.id}
 className="p-5 flex flex-col lg:flex-row gap-6 lg:items-center justify-between hover:bg-slate-50/80 transition-all duration-300 group rounded-2xl border border-transparent hover:border-slate-200 hover:shadow-md bg-white"
 >
