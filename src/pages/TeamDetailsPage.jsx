...
export default function TeamDetailsPage() {
 ...
 <div className="bg-white border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/40 p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 mb-6">
 ...
 <h1 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-slate-900 to-slate-600 tracking-tight mb-2">{team.name}</h1>
 <p className="text-slate-600 font-medium">{team.description || 'Tidak ada deskripsi'}</p>
 </div>
 </div>
 {isAdmin && (
 <div>
 <Button size="md" onClick={() => setIsInviteModalOpen(true)} className="bg-gradient-to-r from-[#0b5cff] to-indigo-600 hover:from-[#094acc] hover:to-indigo-700 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-lg shadow-blue-500/30 whitespace-nowrap">
 ...
 <Button type="submit" isLoading={isInviting} className="bg-gradient-to-r from-[#0b5cff] to-indigo-600 hover:from-[#094acc] hover:to-indigo-700 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-md shadow-blue-500/20">Kirim Undangan</Button>
 </div>
 </form>
 </div>
 </div>
