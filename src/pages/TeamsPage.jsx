...
export default function TeamsPage() {
 ...
 <div>
 <Button size="md" onClick={() => setIsAddModalOpen(true)} className="bg-gradient-to-r from-[#0b5cff] to-indigo-600 hover:from-[#094acc] hover:to-indigo-700 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-lg shadow-blue-500/30 whitespace-nowrap">
 ...
 <Button onClick={() => setIsAddModalOpen(true)} className="bg-gradient-to-r from-[#0b5cff] to-indigo-600 hover:from-[#094acc] hover:to-indigo-700 text-white px-8 py-3 rounded-xl font-bold transition-all shadow-lg shadow-blue-500/30">Buat Tim Pertama Anda</Button>
 </div>
 )}

 {teams.map(team => (
 <div key={team.id} className="bg-white border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/40 flex flex-col hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-300 group overflow-hidden">
 ...
 <Button type="submit" isLoading={isSubmitting} className="bg-gradient-to-r from-[#0b5cff] to-indigo-600 hover:from-[#094acc] hover:to-indigo-700 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-md shadow-blue-500/20">Buat Ruang Kerja</Button>
 </div>
 </form>
 </div>
 </div>
 ...
 <Button type="submit" isLoading={isSubmitting} className="bg-gradient-to-r from-[#0b5cff] to-indigo-600 hover:from-[#094acc] hover:to-indigo-700 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-md shadow-blue-500/20">Simpan Perubahan</Button>
 </div>
 </div>
 </form>
 </div>
 ...
 <Button type="submit" isLoading={isSubmitting} className="bg-gradient-to-r from-[#0b5cff] to-indigo-600 hover:from-[#094acc] hover:to-indigo-700 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-md shadow-blue-500/20">Kirim Undangan</Button>
 </div>
 </form>
 </div>
 </div>
