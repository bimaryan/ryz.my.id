...
export default function PagesPage() {
 ...
 <div>
 <Button onClick={() => setIsCreateModalOpen(true)} className="bg-gradient-to-r from-[#0b5cff] to-indigo-600 hover:from-[#094acc] hover:to-indigo-700 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-lg shadow-blue-500/30 whitespace-nowrap">
 ...
 <div key={page.id} className="bg-white border border-slate-200/60 rounded-3xl shadow-md overflow-hidden flex flex-col hover:shadow-xl hover:border-[#0b5cff]/30 transition-all duration-300 group">
 ...
 {!searchQuery && (
 <Button onClick={() => setIsCreateModalOpen(true)} className="bg-gradient-to-r from-[#0b5cff] to-indigo-600 hover:from-[#094acc] hover:to-indigo-700 text-white px-6 py-3 rounded-xl font-bold transition-all shadow-lg shadow-blue-500/30">
 ...
 <Button type="submit" isLoading={isSubmitting} className="bg-gradient-to-r from-[#0b5cff] to-indigo-600 hover:from-[#094acc] hover:to-indigo-700 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-md shadow-blue-500/20">
 Buat Halaman
 </Button>
 </div>
 </form>
