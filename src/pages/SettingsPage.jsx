...
export default function SettingsPage() {
 ...
 <Button type="submit" isLoading={isProfileSubmitting || isLoading} className="bg-gradient-to-r from-[#0b5cff] to-indigo-600 hover:from-[#094acc] hover:to-indigo-700 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-md shadow-blue-500/20">Simpan Perubahan</Button>
 </div>
 </form>
 )}
 ...
 <div className="pt-6 mt-6 border-t border-slate-100">
 <Button type="submit" isLoading={isSavingEcommerce} className="bg-gradient-to-r from-[#0b5cff] to-indigo-600 hover:from-[#094acc] hover:to-indigo-700 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-md shadow-blue-500/20">Simpan Pengaturan E-Commerce</Button>
 </div>
 </form>
 )}
