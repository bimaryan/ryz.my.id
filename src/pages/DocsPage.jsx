...
export default function DocsPage() {
 ...
 <Link to="/dashboard" className="text-sm font-bold bg-gradient-to-r from-[#0b5cff] to-indigo-600 text-white px-5 py-2.5 rounded-full hover:shadow-lg transition-all shadow-md">Dashboard</Link>
 </div>
 </div>
 </header>
